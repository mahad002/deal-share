    ...
    <form className="max-w-md mx-auto p-4 bg-white rounded-md shadow-md" onSubmit={saveProduct}>
      ...
      <div className="mb-2 flex flex-wrap gap-2">
        ...
        <div className="mt-4 p-6 bg-blue-100 max-w-md mx-auto rounded-lg mb-8 mt-6">
          ...
          />
          <div className="flex flex-row gap-2 items-center justify-center pr-1">
            <input
              className="border rounded p-2 flex-grow"
              type="text"
              value={newPropData}
          ...
          {Array.isArray(properties) && properties.length > 0 && (
            <div className="bg-blue-200 p-2 flex flex-wrap gap-2 mt-4 justify-center items-center p-5 rounded-md mb-3">
              {properties.map((prop, index) => (
                <div key={index}>
                  <button className="btn-primary" type="button" onClick={() => handleRemoveProperties(prop)}>
                    {prop.name}
