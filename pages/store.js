                ...
                <div className="product-container">
                    ...
                    products.map((product, index) => (
                        ...
                        <div className="items-center mb-2 justify-center">
                            ...
                            <Link href={`/store/edit/${product._id}`} className="link-button flex flex-wrap bg-blue-900 text-white rounded-lg p-1">
                            ...
                            <Link href={`/store/delete/${product._id}`} className="link-button-red flex flex-wrap bg-blue-900 text-white rounded-lg p-1">
