...
export default function Products() {
    ...
    return (
        <Layout>
          <h1 className="hea  ding font-bold text-4xl">Products</h1>
          <Link href={'/products/newproduct'} className="rounded-lg bg-blue-900 text-white py-1 px-2 inline-block mt-4 mb-4 mr-4">
            Add new product
          </Link>
