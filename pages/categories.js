                ...
                {Object.keys(categorySpecsMapping).map((categoryOption) => (
                    <div key={categoryOption} className="bg-white p-4 rounded-lg shadow-lg">
                        ...
                        <div className='justify-end items-end'>
                                <button className='bg-blue-200 rounded-lg p-1 mt-2' onClick={() => {setSelectedCategory(categoryOption), setIsAddingCategory(false) ,setId(findProductIdByName(categoryOption)), console.log(categoryOption) ,console.log("ID: ",_id)}}>Select</button>
                        </div>
                    </div>
                ))}
            </div>
              ...
              products.map((product, index) => (
                ...
                >
                  <div className="items-center mb-2 justify-center">
                    ...
                    <Link href={`/products/delete/${product._id}`} className="link-button flex flex-wrap bg-blue-900 text-white rounded-lg p-1">
